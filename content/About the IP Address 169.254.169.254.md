...
link:
---
The IP address `169.254.169.254` is a **special-purpose IP address** used by cloud providers like **Azure, AWS, and Google Cloud** to provide **instance metadata** to virtual machines (VMs).
