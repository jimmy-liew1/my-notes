...
link:
---
Scrum is a specific framework within the [[Agile]] umbrella. It provides structured roles (like [[Scrum Master]], [[Product Owner]], and [[Development Team]]), defined ceremonies (like [[Daily Stand-ups]], [[sprint plan]], and [[sprint retro|Retrospectives]]), and uses time-boxed iterations (called Sprints). Scrum is one of the most popular ways to implement Agile, but it is not synonymous with Agile itself.